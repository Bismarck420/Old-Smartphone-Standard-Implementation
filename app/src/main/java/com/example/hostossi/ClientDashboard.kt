 ...
 * Use the [ClientDashboard.newInstance] factory method to
...
class ClientDashboard : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("test", "this happens in onCreate")
    ...
    override fun onCreateView(
        ...
        Log.d("test", "this happens in onCreateView")
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ClientDashboard.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClientDashboard().apply {
