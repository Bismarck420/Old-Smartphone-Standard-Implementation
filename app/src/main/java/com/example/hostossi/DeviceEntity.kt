...
@Entity(tableName = "devices", indices = [Index("manager_id")])
@Serializable
data class DeviceEntity(
    ...
    /** Stable ID from the manager advertisement; used to detect removed or changed channels. */
    @ColumnInfo("manager_peripheral_id") val managerPeripheralId: String = "",
    ...
    /** Stable Android device identity. Empty keeps legacy client-owned assignments working. */
    @ColumnInfo("source_device_id") val sourceDeviceId: String = "",
    @ColumnInfo("source_device_name") val sourceDeviceName: String = "",
